...
VALUES (2, 1, 2, 'CHECK_CARD', 'LINKED',
    '신한 체인지업 체크카드', '****-****-****-7842', '신한카드', true, @now, @now, @now, 'ACTIVE');
...
(101, 1, 2, 'Anthropic',       '구독',  20.0000, 'USD', '2026-04-01 09:00:00', 1530.5000, 1545.8000, @now, @now, 'ACTIVE'),
(102, 1, 2, 'Adobe',           '구독',  54.9900, 'USD', '2026-04-03 09:00:00', 1518.8000, 1533.9800, @now, @now, 'ACTIVE'),
(103, 1, 2, 'Microsoft 365',   '구독',   9.9900, 'USD', '2026-04-08 09:00:00', 1506.8000, 1521.8600, @now, @now, 'ACTIVE'),
(104, 1, 2, 'Spotify',         '콘텐츠',  10.9900, 'USD', '2026-04-10 09:00:00', 1481.1000, 1495.9100, @now, @now, 'ACTIVE'),
(105, 1, 2, 'Notion',          '구독',   8.0000, 'USD', '2026-04-12 09:00:00', 1481.1000, 1495.9100, @now, @now, 'ACTIVE'),  -- 토요일 → 04/10 환율 사용
(106, 1, 2, 'OpenAI',          '구독',  20.0000, 'USD', '2026-04-15 09:00:00', 1481.4000, 1496.2100, @now, @now, 'ACTIVE'),
(107, 1, 2, 'GitHub',          '구독',  10.0000, 'USD', '2026-04-20 09:00:00', 1480.0000, 1494.8000, @now, @now, 'ACTIVE'),
(108, 1, 2, 'Netflix',         '콘텐츠',  15.4900, 'USD', '2026-04-22 09:00:00', 1470.8000, 1485.5000, @now, @now, 'ACTIVE');

-- ── 구독 5월 + 일반 결제 (실제 수출입은행 환율 적용) ─────────────────────
INSERT IGNORE INTO card_transactions (id, user_id, card_id, merchant_name, category, amount, currency, transacted_at, base_rate_at_time, tts_at_time, created_at, updated_at, status) VALUES
(201, 1, 2, 'Anthropic',       '구독',  20.0000, 'USD', '2026-05-01 09:00:00', 1476.1000, 1490.8600, @now, @now, 'ACTIVE'),  -- 공휴일 → 04/30 환율
(202, 1, 2, 'Adobe',           '구독',  54.9900, 'USD', '2026-05-03 09:00:00', 1476.1000, 1490.8600, @now, @now, 'ACTIVE'),  -- 토요일 → 04/30 환율
(203, 1, 2, 'Microsoft 365',   '구독',   9.9900, 'USD', '2026-05-08 09:00:00', 1450.8000, 1465.3000, @now, @now, 'ACTIVE'),
(204, 1, 2, 'Spotify',         '콘텐츠',  10.9900, 'USD', '2026-05-10 09:00:00', 1450.8000, 1465.3000, @now, @now, 'ACTIVE'),  -- 토요일 → 05/08 환율
(205, 1, 2, 'Notion',          '구독',   8.0000, 'USD', '2026-05-12 09:00:00', 1473.0000, 1487.7300, @now, @now, 'ACTIVE'),
(206, 1, 2, 'OpenAI',          '구독',  20.0000, 'USD', '2026-05-15 09:00:00', 1491.8000, 1506.7100, @now, @now, 'ACTIVE'),
(207, 1, 2, 'GitHub',          '구독',  10.0000, 'USD', '2026-05-20 09:00:00', 1503.8000, 1518.8300, @now, @now, 'ACTIVE'),
(208, 1, 2, 'Netflix',         '콘텐츠',  15.4900, 'USD', '2026-05-22 09:00:00', 1503.5000, 1518.5300, @now, @now, 'ACTIVE'),
(209, 1, 2, 'Amazon',          '쇼핑',      89.9900, 'USD', '2026-05-05 14:30:00', 1456.8000, 1471.3600, @now, @now, 'ACTIVE'),  -- 공휴일 → 05/07 환율
(210, 1, 2, 'Starbucks',       '여행',           6.5000, 'USD', '2026-05-07 08:20:00', 1456.8000, 1471.3600, @now, @now, 'ACTIVE'),
(211, 1, 2, 'Uber',            '여행',     23.4000, 'USD', '2026-05-09 19:10:00', 1450.8000, 1465.3000, @now, @now, 'ACTIVE'),  -- N/A → 05/08 환율
(212, 1, 2, 'Chipotle',        '여행',    14.5000, 'USD', '2026-05-14 12:40:00', 1495.1000, 1510.0500, @now, @now, 'ACTIVE'),
(213, 1, 2, 'Walmart',         '여행',      145.6000, 'USD', '2026-05-18 16:00:00', 1499.8000, 1514.7900, @now, @now, 'ACTIVE'),
(214, 1, 2, 'McDonald',        '여행',    12.3000, 'USD', '2026-05-21 13:00:00', 1509.7000, 1524.7900, @now, @now, 'ACTIVE'),
(215, 1, 2, 'Starbucks',       '여행',           5.8000, 'USD', '2026-05-25 09:00:00', 1503.5000, 1518.5300, @now, @now, 'ACTIVE'),  -- 공휴일 → 05/22 환율
(216, 1, 2, 'Uber Eats',       '여행',      32.9000, 'USD', '2026-05-27 19:30:00', 1507.9000, 1522.9700, @now, @now, 'ACTIVE');

-- ── 구독 6월 + 일반 결제 (실제 수출입은행 환율 적용) ─────────────────────
INSERT IGNORE INTO card_transactions (id, user_id, card_id, merchant_name, category, amount, currency, transacted_at, base_rate_at_time, tts_at_time, created_at, updated_at, status) VALUES
(301, 1, 2, 'Anthropic',       '구독',  20.0000, 'USD', '2026-06-01 09:00:00', 1503.2000, 1518.2300, @now, @now, 'ACTIVE'),
(302, 1, 2, 'Adobe',           '구독',  54.9900, 'USD', '2026-06-03 09:00:00', 1511.3000, 1526.4100, @now, @now, 'ACTIVE'),  -- 토요일 → 06/02 환율
(303, 1, 2, 'Microsoft 365',   '구독',   9.9900, 'USD', '2026-06-08 09:00:00', 1543.0000, 1558.4300, @now, @now, 'ACTIVE'),
(304, 1, 2, 'Spotify',         '콘텐츠',  10.9900, 'USD', '2026-06-10 09:00:00', 1518.4000, 1533.5800, @now, @now, 'ACTIVE'),
(305, 1, 2, 'Notion',          '구독',   8.0000, 'USD', '2026-06-12 09:00:00', 1527.0000, 1542.2700, @now, @now, 'ACTIVE'),
(306, 1, 2, 'OpenAI',          '구독',  20.0000, 'USD', '2026-06-15 09:00:00', 1520.4000, 1535.6000, @now, @now, 'ACTIVE'),
(307, 1, 2, 'GitHub',          '구독',  10.0000, 'USD', '2026-06-20 09:00:00', 1523.4000, 1538.6300, @now, @now, 'ACTIVE'),  -- N/A → 06/19 환율
(308, 1, 2, 'Netflix',         '콘텐츠',  15.4900, 'USD', '2026-06-22 09:00:00', 1535.0000, 1550.3500, @now, @now, 'ACTIVE'),
(309, 1, 2, 'Amazon',          '쇼핑',     134.9900, 'USD', '2026-06-02 11:20:00', 1511.3000, 1526.4100, @now, @now, 'ACTIVE'),
(310, 1, 2, 'Starbucks',       '여행',           7.2000, 'USD', '2026-06-04 08:10:00', 1515.6000, 1530.7500, @now, @now, 'ACTIVE'),
(311, 1, 2, 'Uber',            '여행',     18.9000, 'USD', '2026-06-05 20:00:00', 1528.6000, 1543.8800, @now, @now, 'ACTIVE'),
(312, 1, 2, 'Target',          '여행',       67.8000, 'USD', '2026-06-07 15:30:00', 1528.6000, 1543.8800, @now, @now, 'ACTIVE'),  -- 일요일 → 06/05 환율
(313, 1, 2, 'Chipotle',        '여행',    15.2000, 'USD', '2026-06-09 12:30:00', 1546.5000, 1561.9600, @now, @now, 'ACTIVE'),
(314, 1, 2, 'McDonald',        '여행',     8.9000, 'USD', '2026-06-11 13:10:00', 1522.4000, 1537.6200, @now, @now, 'ACTIVE'),
(315, 1, 2, 'Shake Shack',     '여행',    18.5000, 'USD', '2026-06-13 12:00:00', 1527.0000, 1542.2700, @now, @now, 'ACTIVE'),  -- 토요일 → 06/12 환율
(316, 1, 2, 'AliExpress',      '쇼핑',      42.3000, 'USD', '2026-06-16 10:00:00', 1510.0000, 1525.1000, @now, @now, 'ACTIVE'),
(317, 1, 2, 'Uber Eats',       '여행',      28.7000, 'USD', '2026-06-18 19:00:00', 1512.8000, 1527.9200, @now, @now, 'ACTIVE'),
(318, 1, 2, 'Walmart',         '여행',      112.4000, 'USD', '2026-06-19 16:30:00', 1523.4000, 1538.6300, @now, @now, 'ACTIVE'),
(319, 1, 2, 'PlayStation',     '콘텐츠',          59.9900, 'USD', '2026-06-21 22:00:00', 1523.4000, 1538.6300, @now, @now, 'ACTIVE'),  -- 일요일 → 06/19 환율
(320, 1, 2, 'Starbucks',       '여행',           6.8000, 'USD', '2026-06-23 08:30:00', 1535.7000, 1551.0500, @now, @now, 'ACTIVE'),
(321, 1, 2, 'DoorDash',        '여행',      35.6000, 'USD', '2026-06-24 18:30:00', 1537.2000, 1552.5700, @now, @now, 'ACTIVE');
