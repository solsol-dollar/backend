...
-- 쏠 (user_id=1) ─────────────────────────────────────────────────────
    (15, 1, 'SECURITIES', 'SECURITIES_FIRM', '신한투자증권',
     '신한투자증권 CMA 외화 계좌', '11062371849', '11071829304', 'USD', 5000.0000,
     NULL, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),
    (16, 1, 'SECURITIES', 'SECURITIES_FIRM', '신한투자증권',
     '신한투자증권 CMA 원화 계좌', '11062371849', NULL, 'KRW', 0.0000,
     NULL, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),
    (17, 1, 'DEPOSIT', 'BANK', '신한은행',
     '신한 외화 체인지업 예금', '11083920147', NULL, 'USD', 0.0000,
     2.5000, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),

-- 몰리 (user_id=2) ────────────────────────────────────────────────────
    (18, 2, 'SECURITIES', 'SECURITIES_FIRM', '신한투자증권',
     '신한투자증권 CMA 외화 계좌', '11074829301', '11082930417', 'USD', 5000.0000,
     NULL, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),
    (19, 2, 'SECURITIES', 'SECURITIES_FIRM', '신한투자증권',
     '신한투자증권 CMA 원화 계좌', '11074829301', NULL, 'KRW', 0.0000,
     NULL, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),
    (20, 2, 'DEPOSIT', 'BANK', '신한은행',
     '신한 외화 체인지업 예금', '11091738294', NULL, 'USD', 0.0000,
     2.5000, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),

-- 리노 (user_id=3) ────────────────────────────────────────────────────
    (21, 3, 'SECURITIES', 'SECURITIES_FIRM', '신한투자증권',
     '신한투자증권 CMA 외화 계좌', '11083901284', '11093012847', 'USD', 5000.0000,
     NULL, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),
    (22, 3, 'SECURITIES', 'SECURITIES_FIRM', '신한투자증권',
     '신한투자증권 CMA 원화 계좌', '11083901284', NULL, 'KRW', 0.0000,
     NULL, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),
    (23, 3, 'DEPOSIT', 'BANK', '신한은행',
     '신한 외화 체인지업 예금', '11014827391', NULL, 'USD', 0.0000,
     2.5000, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),

-- 슈 (user_id=4) ──────────────────────────────────────────────────────
    (24, 4, 'SECURITIES', 'SECURITIES_FIRM', '신한투자증권',
     '신한투자증권 CMA 외화 계좌', '11092013849', '11014738291', 'USD', 5000.0000,
     NULL, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),
    (25, 4, 'SECURITIES', 'SECURITIES_FIRM', '신한투자증권',
     '신한투자증권 CMA 원화 계좌', '11092013849', NULL, 'KRW', 0.0000,
     NULL, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),
    (26, 4, 'DEPOSIT', 'BANK', '신한은행',
     '신한 외화 체인지업 예금', '11023819204', NULL, 'USD', 0.0000,
     2.5000, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),

-- 도레미 (user_id=5) ──────────────────────────────────────────────────
    (27, 5, 'SECURITIES', 'SECURITIES_FIRM', '신한투자증권',
     '신한투자증권 CMA 외화 계좌', '11012938401', '11023849102', 'USD', 5000.0000,
     NULL, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),
    (28, 5, 'SECURITIES', 'SECURITIES_FIRM', '신한투자증권',
     '신한투자증권 CMA 원화 계좌', '11012938401', NULL, 'KRW', 0.0000,
     NULL, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),
    (29, 5, 'DEPOSIT', 'BANK', '신한은행',
     '신한 외화 체인지업 예금', '11034012837', NULL, 'USD', 0.0000,
     2.5000, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),

-- 플리 (user_id=6) ────────────────────────────────────────────────────
    (30, 6, 'SECURITIES', 'SECURITIES_FIRM', '신한투자증권',
     '신한투자증권 CMA 외화 계좌', '11024730182', '11034901827', 'USD', 5000.0000,
     NULL, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),
    (31, 6, 'SECURITIES', 'SECURITIES_FIRM', '신한투자증권',
     '신한투자증권 CMA 원화 계좌', '11024730182', NULL, 'KRW', 0.0000,
     NULL, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),
    (32, 6, 'DEPOSIT', 'BANK', '신한은행',
     '신한 외화 체인지업 예금', '11043718290', NULL, 'USD', 0.0000,
     2.5000, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),

-- 레이 (user_id=7) ────────────────────────────────────────────────────
    (33, 7, 'SECURITIES', 'SECURITIES_FIRM', '신한투자증권',
     '신한투자증권 CMA 외화 계좌', '11038190274', '11043027198', 'USD', 5000.0000,
     NULL, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),
    (34, 7, 'SECURITIES', 'SECURITIES_FIRM', '신한투자증권',
     '신한투자증권 CMA 원화 계좌', '11038190274', NULL, 'KRW', 0.0000,
     NULL, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000),
    (35, 7, 'DEPOSIT', 'BANK', '신한은행',
     '신한 외화 체인지업 예금', '11052901847', NULL, 'USD', 0.0000,
     2.5000, NULL, TRUE, @now, @now, @now, 'ACTIVE', 0.0000);
